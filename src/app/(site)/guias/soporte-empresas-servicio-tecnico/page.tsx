...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Servicio Técnico de Celulares para Empresas en CABA | Team Celular",
    description:
      "Team Celular, Paraguay 2451 Recoleta y Amenábar 2032 Belgrano, presta soporte técnico de celulares para empresas. SLA, logística puerta a puerta, desde 5 dispositivos. Garantía escrita 90 días.",
    type: "article",
        ...
        <section className="overflow-hidden rounded-2xl border border-white/15 bg-white/5 backdrop-blur-xl dark:border-white/10 dark:bg-slate-900/30">
          <div className="grid gap-0 md:grid-cols-5">
            ...
            <ul className="ml-6 list-disc space-y-2">
              ...
              <li>
                <strong>?reas de IT y compras:</strong> Histórico de intervenciones, costo total de
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description":
                "Team Celular, en Paraguay 2451 Recoleta y Amenábar 2032 Belgrano (CABA), presta soporte técnico de celulares para empresas desde 5 dispositivos: SLA garantizado, logística puerta a puerta, planes preventivos y diagnóstico en menos de 24 horas.",
              "provider": {
