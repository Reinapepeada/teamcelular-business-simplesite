...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Microelectrónica y Reballing BGA en Buenos Aires | Team Celular",
    description:
      "Team Celular, Paraguay 2451 Recoleta y Amenábar 2032 Belgrano (CABA). Reballing BGA, soldadura SMD y reparación de placas lógicas con microscopio y garantía escrita de 90 días.",
    type: "article",
        ...
        <section className="grid gap-8 overflow-hidden rounded-2xl border border-white/15 bg-white/5 backdrop-blur-xl dark:border-white/10 dark:bg-slate-900/30 md:grid-cols-2">
          ...
          <div className="order-1 space-y-6 p-10 md:order-2">
            ...
            <div className="space-y-4 text-lg leading-relaxed text-slate-700 dark:text-slate-300">
              ...
              <p>
                Team Celular, en Paraguay 2451 Recoleta y Amenábar 2032 Belgrano (CABA), documenta fotográficamente cada etapa del proceso, trabaja bajo <strong className="text-secondary">normas ESD</strong> y entrega garantía escrita de 90 días en toda intervención de microelectrónica — incluyendo reballing y reconstrucción de pistas.
              </p>
            </div>
          </div>
        </section>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description":
                "Team Celular, Paraguay 2451 Recoleta y Amenábar 2032 Belgrano (CABA). Reballing BGA, soldadura SMD y reparación de placas lógicas con microscopio trinocular, protocolos ESD y garantía escrita de 90 días.",
              "hasOfferCatalog": {
                "@type": "OfferCatalog",
