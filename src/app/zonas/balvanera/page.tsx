...
const ZONE_NAME = "Balvanera";
const PAGE_URL = `${SITE_URL}/zonas/balvanera`;

const highlights = [
  {
    title: "Pantalla y módulo",
    desc: "Display sin imagen, touch que no responde o vidrio roto. Cambio de módulo y pruebas completas.",
  },
  {
    title: "Carga y batería",
    desc: "Pin de carga, flex y batería degradada. Solución según diagnóstico y repuesto disponible.",
  },
  {
    title: "Reparación avanzada",
    desc: "Mojado, corto, no enciende o reinicios. Diagnóstico y reparación de placa (microelectrónica).",
  },
];

const localNotes = [
  "En Balvanera/Once suelen entrar equipos por desgaste de carga (uso intensivo) y pantallas dañadas por caídas.",
  "Si el equipo se mojó (lluvia/derrame), conviene apagarlo y traerlo cuanto antes para evitar corrosión.",
  "Cuando hay fallas intermitentes, hacemos diagnóstico para diferenciar software vs hardware.",
];

const faqs = [
  {
    q: `¿Hacen arreglo de celulares para ${ZONE_NAME} (Once)?`,
    a: "Sí. Atendemos Balvanera/Once y toda CABA. Podés venir al taller en Recoleta o pedir presupuesto online.",
  },
  {
    q: "¿Qué conviene hacer si el celular se mojó?",
    a: "Apagalo, no lo cargues y traelo cuanto antes. La limpieza y el diagnóstico temprano aumentan mucho las chances de recuperación.",
  },
  {
    q: "¿Se puede arreglar el pin de carga sin cambiarlo?",
    a: "Depende del caso. A veces es limpieza o ajuste; otras veces conviene reemplazo. Te confirmamos con diagnóstico.",
  },
  {
    q: `¿Cómo llego desde ${ZONE_NAME} al taller?`,
    a: "Estamos en Paraguay 2451, Recoleta. Desde Once podés llegar en colectivo/taxi o combinando subte y caminata corta. En contacto tenés el mapa.",
  },
];

export const metadata: Metadata = {
  title: `Arreglo de Celulares en ${ZONE_NAME} (CABA) | Team Celular`,
  description: `Arreglo de celulares para ${ZONE_NAME}, CABA (Once): pantalla, batería, carga y microelectrónica. Taller en Recoleta con garantía por escrito y presupuesto rápido.`,
...
export default function ZonaBalvaneraPage() {
  const whatsappUrl = `https://wa.me/5491151034595?text=${encodeURIComponent(
    `Hola! Quiero un presupuesto para arreglo de celular desde ${ZONE_NAME}/Once. Marca y modelo:`
  )}`;
    ...
    <section className="w-full max-w-6xl px-6 py-14 md:px-8">
      ...
      <header className="rounded-2xl border border-white/15 bg-white/5 p-10 text-center shadow-lg backdrop-blur-2xl dark:border-white/10 dark:bg-slate-900/30 md:p-12">
        <h1 className="text-4xl font-bold tracking-tight text-slate-900 dark:text-white md:text-5xl">
          Arreglo de celulares para {ZONE_NAME} / Once (CABA)
        </h1>
        <p className="mx-auto mt-5 max-w-3xl text-lg leading-relaxed text-slate-600 dark:text-slate-300">
          Para {ZONE_NAME} y zona Once: pantalla, batería, carga y reparación de
          placa. Taller en <strong>Recoleta</strong>, con{" "}
      ...
      <section className="mt-10 rounded-2xl border border-white/15 bg-white/5 p-8 shadow-lg backdrop-blur-2xl dark:border-white/10 dark:bg-slate-900/30">
        ...
        <p className="mt-5 text-slate-600 dark:text-slate-300">
          Para evitar gastos innecesarios, hacemos diagnóstico y te explicamos
          opciones antes de reparar.
        </p>
      </section>
      ...
      <section className="mt-10 rounded-2xl border border-white/15 bg-white/5 p-8 shadow-lg backdrop-blur-2xl dark:border-white/10 dark:bg-slate-900/30">
        ...
        <p className="mt-3 text-slate-600 dark:text-slate-300">
          Estamos en Paraguay 2451 (Recoleta). Desde Once suelen ser 10–25
          minutos según el tránsito. En la página de contacto tenés el mapa y
