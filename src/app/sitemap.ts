...
const mainPages = [
  ...
  { path: "reparaciones/cambio-camara-caba", priority: 0.88, changeFreq: "weekly" as const },
  { path: "reparaciones/reparacion-audio-celular-caba", priority: 0.88, changeFreq: "weekly" as const },
  { path: "reparaciones/recuperacion-celular-mojado-caba", priority: 0.88, changeFreq: "weekly" as const },
  { path: "reparaciones/reparacion-placa-caba", priority: 0.9, changeFreq: "weekly" as const },
  { path: "reparaciones/iphone/11", priority: 0.86, changeFreq: "monthly" as const },
  { path: "reparaciones/iphone/12", priority: 0.86, changeFreq: "monthly" as const },
  { path: "reparaciones/iphone/13", priority: 0.86, changeFreq: "monthly" as const },
  { path: "reparaciones/iphone/13-mini", priority: 0.84, changeFreq: "monthly" as const },
  { path: "reparaciones/iphone/13-pro", priority: 0.84, changeFreq: "monthly" as const },
  { path: "reparaciones/iphone/14", priority: 0.85, changeFreq: "monthly" as const },
  { path: "reparaciones/iphone/14-pro", priority: 0.84, changeFreq: "monthly" as const },
  { path: "reparaciones/iphone/14-pro-max", priority: 0.86, changeFreq: "monthly" as const },
  ...
  { path: "en/phone-repair-buenos-aires", priority: 0.85, changeFreq: "monthly" as const },
...
const guidePages = [
  ...
  { path: "guias/reparacion-oppo-buenos-aires", priority: 0.8, changeFreq: "monthly" as const },
  { path: "guias/reparacion-infinix-buenos-aires", priority: 0.78, changeFreq: "monthly" as const },
  { path: "guias/reparacion-zte-buenos-aires", priority: 0.78, changeFreq: "monthly" as const },
  { path: "guias/reparacion-tecno-buenos-aires", priority: 0.78, changeFreq: "monthly" as const },
  { path: "guias/reparacion-alcatel-buenos-aires", priority: 0.76, changeFreq: "monthly" as const },
  { path: "guias/reparacion-asus-buenos-aires", priority: 0.79, changeFreq: "monthly" as const },
  { path: "guias/reparacion-oneplus-buenos-aires", priority: 0.8, changeFreq: "monthly" as const },
  ...
  { path: "guias/reparacion-pantalla-celular", priority: 0.78, changeFreq: "monthly" as const },
