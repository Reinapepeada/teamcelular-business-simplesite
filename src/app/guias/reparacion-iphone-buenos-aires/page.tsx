...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Reparación iPhone Buenos Aires | Service Certificado",
    description: "Service técnico iPhone: pantallas OLED, baterías certificadas, True Tone. Garantía 6 meses.",
  },
  alternates: {
