...
export default function RootLayout({
    ...
    return (
        <html lang="es">
            <Head>
                <title>
                    Reparaciones de Celulares y Computadoras en Buenos Aires |
                    Team Celular
                </title>
                <meta
                    name="description"
                    content="Team Celular ofrece servicios de reparación de alta calidad para celulares y computadoras en Buenos Aires. Nuestros técnicos expertos están listos para ayudarte."></meta>
                <meta
                    name="keywords"
                    content="Reparación de Celulares Buenos Aires, Reparación de Computadoras Buenos Aires, Servicio Técnico Buenos Aires, Team Celular"></meta>
                ...
                <meta
                    property="og:title"
                    content="Reparaciones de Celulares y Computadoras en Buenos Aires | Team Celular"></meta>
                <meta
                    property="og:description"
                    content="Team Celular ofrece servicios de reparación de alta calidad para celulares y computadoras en Buenos Aires. Nuestros técnicos expertos están listos para ayudarte."></meta>
                <meta
                    property="og:image"
                    content="/images/teamcelular.png"></meta>
                <meta
                    property="og:url"
                    content="https://teamcelular.com/"></meta>
